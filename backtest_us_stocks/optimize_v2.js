...
import fs from "fs";
import { STOCKS_UNIVERSE as PAIRS } from "../bot/universes/stocks.js";
...
async function loadData() {
    ...
    for (const p of PAIRS) {
        const symbol = p;
        const candles15m = await getCandles(symbol, "15m", "stocks");
        const candles1h = await getCandles(symbol, "1h", "stocks");
